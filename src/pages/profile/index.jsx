      ...
      <div className="bg-slate-400 m-6 rounded-lg h-60">
        <div className="flex justify-left">
          ...
          <div className="block mt-4 ml-6">
            ...
            <div className="flex">
              <input
                className=" border border-solid border-gray-300 rounded-md w-12"
                placeholder=" 001"
              />
              <input
                className=" ml-4 border border-solid border-gray-300 rounded-md w-52"
                placeholder=" 7363 1616 84"
              />
            </div>
            {/*Nama Rek */}
            <div className="block mt-4 ">
              ...
              <input
                className=" border border-solid border-gray-300 rounded-md w-52"
                placeholder=" Anak Ilang"
              />
            </div>
