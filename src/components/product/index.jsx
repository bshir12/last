    ...
    return (
        <>
            <div className=' justify-center m-1 md:m-8'>
                ...
                <div className='flex row list-none justify-center bg-blue-400 rounded-xl'>
                    <div className='p1'>
                    ...
                    <div className='p1'>
                        <li className='bg-white box-decoration-clone md:w-44 md:h-48 md:m-5 w-20 h-32 rounded-xl shadow-2xl ml-2'>
                            <div className='w-14 h-8 md:ml-16 ml-3 my-8'>
                                <img src={require('./img/deposit.png')} alt="3" />
                            </div>
                            <p className='text-center font-semibold text-base'>Deposito</p>
                            <p className='text-center my-4 text-sm md:visible invisible md:visible invisible'>Simpan dan Dapatkan Keuntunganmu</p>
                        </li>
                    </div>
                </div>
            </div>
